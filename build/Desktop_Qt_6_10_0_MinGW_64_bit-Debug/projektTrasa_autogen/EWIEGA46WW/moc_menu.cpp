...
template <> constexpr inline auto Menu::qt_create_metaobjectdata<qt_meta_tag_ZN4MenuE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        "Menu",
        "on_listaButton_clicked",
        "",
        "on_mapaButton_clicked",
        "on_profilButton_clicked"
    };

    QtMocHelpers::UintData qt_methods {
        // Slot 'on_listaButton_clicked'
        QtMocHelpers::SlotData<void()>(1, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_mapaButton_clicked'
        QtMocHelpers::SlotData<void()>(3, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_profilButton_clicked'
...
void Menu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->on_listaButton_clicked(); break;
        case 1: _t->on_mapaButton_clicked(); break;
        case 2: _t->on_profilButton_clicked(); break;
        default: ;
        }
    }
    (void)_a;
